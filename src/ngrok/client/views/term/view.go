...
func (v *TermView) draw() {
	...
	case mvc.UpdateAvailable:
		updateMsg = "new version available at https://www.echosite.cn"
	default:
	...
	v.APrintf(termbox.ColorYellow|termbox.AttrBold, 0, 0, "EchoSite")
	v.APrintf(termbox.ColorYellow|termbox.AttrBold, 30, 0, "https://www.echosite.cn")
